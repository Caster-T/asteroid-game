...
def draw_game_over(screen, score, high_score, screen_width, screen_height):
    ...
    high_score_text = high_score_font.render(f"High score {int(high_score)}", True, (255,255,255))
